                ...
                if (sourceId.includes('.')) {
                    ...
                    if (request.media.customData.licenseUrl) {
                        playerManager.setMediaPlaybackInfoHandler((loadRequest, playbackConfig) => {
                            ...
                            if (typeof loadRequestData.media.customData.credentials === 'boolean' || typeof loadRequestData.media.customData.licenseHeaders === 'object') {
                                playbackConfig.licenseRequestHandler = requestInfo => {
                                    if (typeof loadRequestData.media.customData.credentials === 'boolean') {
                                        requestInfo.withCredentials = request.media.customData.credentials;
                                    }
                                    if (typeof loadRequestData.media.customData.licenseHeaders === 'object') {
